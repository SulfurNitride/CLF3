...
//!
//! ```rust,ignore
//! use clf3::game_finder::{detect_all_games, Launcher};
//!
...
pub use known_games::{
    ...
    variants_for_wabbajack_type, KnownGame, KNOWN_GAMES,
};
...
/// Detect only Heroic games (GOG and Epic)
pub fn detect_heroic_only() -> GameScanResult {
    let heroic_games = detect_heroic_games();
    GameScanResult {
        heroic_count: heroic_games.len(),
        games: heroic_games,
        ..Default::default()
    }
}
